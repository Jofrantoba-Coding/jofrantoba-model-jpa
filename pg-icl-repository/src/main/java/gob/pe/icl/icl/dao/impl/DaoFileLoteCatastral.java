...
import gob.pe.icl.icl.entity.FileLoteCatastral;
...
import gob.pe.icl.icl.dao.inter.InterDaoFileLoteCatastral;
...
@Repository
public class DaoFileLoteCatastral extends AbstractJpaDao<FileLoteCatastral> implements InterDaoFileLoteCatastral {
    ...
    private Map<String, Object> buildQueryList(FilterFile filter) {
        ...
        String table = "icl.catastro.tgv_file_lote_catastral as base";
    ...
    public void asignarPrincipal(Long id)throws Exception { 
        ...
        sql.append(sharedUtil.append("update icl.catastro.tgv_file_lote_catastral set"));

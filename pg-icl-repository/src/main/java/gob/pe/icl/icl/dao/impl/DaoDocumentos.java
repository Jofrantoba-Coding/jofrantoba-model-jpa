...
import gob.pe.icl.icl.dao.inter.InterDaoDocumentos;
...
@Repository
public class DaoDocumentos extends AbstractJpaDao<Documentos> implements InterDaoDocumentos {
    ...
    private Map<String, Object> buildQueryList(FilterDocumentos filter) {
        ...
        String table = "icl.catastro.tgv_documentos as base";

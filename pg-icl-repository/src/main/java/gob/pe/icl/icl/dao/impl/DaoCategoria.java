...
import gob.pe.icl.icl.dao.inter.InterDaoCategoria;
...
@Repository
public class DaoCategoria extends AbstractJpaDao<Categoria> implements InterDaoCategoria {
  ...
  @Override
    ...
    private Map<String, Object> buildQueryList(FilterCategoria filter) {
        ...
        String table = "icl.catastro.tm_categoria as base";

...
import gob.pe.icl.icl.dao.inter.InterDaoConstrucciones;
...
@Repository
public class DaoConstrucciones extends AbstractJpaDao<Construcciones> implements InterDaoConstrucciones {
    ...
    private Map<String, Object> buildQueryList(FilterConstrucciones filter) {
        ...
        String table = "icl.catastro.tgv_construcciones as base";
        ...
        joinTables[1] = "inner:icl.catastro.tm_parametrias as nivel:on:base.id_nivel:nivel.id";
